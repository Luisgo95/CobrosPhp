...
<h3>Ingrese el nuevo Usuario</h3>
    <form class="" action="../Controlador/Usuarios/ControlUsuario.php" method="post">
      ...
      <br>
        <div class="input-group">
          ...
          <input type="password" name="contra2"class="form-control" placeholder="Contraseña" aria-describedby="basic-addon1"required>
        </div>
          <br>
            <div >
